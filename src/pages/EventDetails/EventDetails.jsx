...
const EventDetails = () => {
  ...
  // Set dynamic metadata for the event
  usePageMetadata('events', event ? {
    title: `${event.title} - God-Life Assembly`,
    description: event.description || `Join us for ${event.title} at God-Life Assembly International. ${event.date} at ${event.time}.`,
    image: event.image || '/assets/images/eventPic.jpg',
    url: `/events/${event.id}`,
    type: 'article',
  } : {});
